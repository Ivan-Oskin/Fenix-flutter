      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Сканировать QR", style: TextStyle(color: Color(0xBF484C52))),
          ],
        ),
      ),
    );
      ...
      child: SizedBox(
        ...
        child: Column(
          children: [
            ...
            const Text("Войти по ID", style: TextStyle(color: Color(0xBF484C52))),
          ],
        ),
      ),
    );
      ...
      child: SizedBox(
        ...
        child: Column(
          children: [
            ...
            const Text("Найти встречу", style: TextStyle(color: Color(0xBF484C52))),
          ],
        ),
      ),
    );
